...
<div class="container">
	...
	<div class="row">
		...
		<table class="table table-hover">
			...
			<?php $__currentLoopData = $data_ktp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dataktp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr>
				<td><?php echo e($dataktp->nama_provinsi); ?></td>
				<td><?php echo e($dataktp->nama_kabkota); ?></td>
				<td><?php echo e($dataktp->NIK); ?></td>
				<td><?php echo e($dataktp->nama); ?></td>
				<td><?php echo e($dataktp->tempat_lahir); ?></td>
				<td><?php echo e($dataktp->tgl_lahir); ?></td>
				<td><?php echo e($dataktp->jenis_kelamin); ?></td>
				<td><?php echo e($dataktp->alamat); ?></td>
				<td><?php echo e($dataktp->agama); ?></td>
				<td><?php echo e($dataktp->status_perkawinan); ?></td>
				<td><?php echo e($dataktp->pekerjaan); ?></td>
				<td><a href="/dataktp/<?php echo e($dataktp->id); ?>/edit" class="btn btn-warning btn-sm">Edit</a></td>
				<td><a href="/dataktp/<?php echo e($dataktp->id); ?>/delete" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Ingin Dihapus?')">Delete</a></td>
			</tr>
...
</html><?php /**PATH C:\Users\ASUS\entrydataktp\resources\views/dataktp/index.blade.php ENDPATH**/ ?>